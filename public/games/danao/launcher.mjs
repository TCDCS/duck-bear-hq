...
let unityInstance=null,starting=false,lastUnityError='';
...
async function start(){
 ...
 }catch(err){const detail=typeof err==='string'?err:err?.message;showFatal(detail||lastUnityError||'The Dǎnào Web build could not start. You can still use the Windows build when it is published.');}
}
