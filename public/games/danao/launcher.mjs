...
async function start(){
 ...
 }catch(err){const detail=typeof err==='string'?err:err?.message;showFatal(detail||lastUnityError||'The Dǎnào Web build could not start. Refresh the page and try again.');}
}
