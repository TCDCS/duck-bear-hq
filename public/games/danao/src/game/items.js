...
export const ITEMS = Object.freeze([
  ...
  item('baguette', 'Baguette', { mass: 1.1, damage: 7, knockback: 6.5, range: 1.82, cooldownMs: 360, throwDamageMax: 14, throwScale: 0.42, size: [0.22, 0.22, 1.3], kind: 'baguette', breakable: true, hp: 10 }),
  item('mallet', 'Foam Mallet', { mass: 3.1, damage: 13, knockback: 11.5, range: 1.78, cooldownMs: 540, throwDamageMax: 22, throwScale: 0.66, size: [1.0, 0.46, 0.36], kind: 'mallet', breakable: true, hp: 22 }),
  ...
  item('cone', 'Traffic Cone', { mass: 1.8, damage: 6, knockback: 7.2, range: 1.48, cooldownMs: 370, throwDamageMax: 15, throwScale: 0.48, size: [0.7, 0.9, 0.7], kind: 'cone', breakable: true, hp: 16 }),
