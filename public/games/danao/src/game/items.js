...
export const ITEMS = Object.freeze([
  item('chair', 'Folding Chair', { mass: 5.2, damage: 14, knockback: 10.5, range: 1.75, cooldownMs: 560, throwDamageMax: 24, throwScale: 0.72, size: [0.95, 1.25, 0.34], kind: 'chair' }),
  ...
  item('bin', 'Bin', { mass: 7.5, damage: 16, knockback: 13.5, range: 1.38, cooldownMs: 690, throwDamageMax: 27, throwScale: 0.8, size: [0.75, 0.95, 0.75], kind: 'bin' }),
