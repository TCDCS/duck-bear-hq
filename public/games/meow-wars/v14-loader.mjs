/* Meow Wars v1.4 production loader.
 * Real v0.5 gameplay payload + cumulative HD/game-feel/polish/presentation/release/living/online/environment/material layers.
 */
const VERSION = '1.4.0';
const BUILD = 'mw-v14-atmosphere-materials-20260918a';

async function readProductionSource() {
  const urls = Array.from({ length: 6 }, (_, i) => './v05-payload-' + (i + 1) + '.txt?v=14a');
...
async function start() {
  const [v05, hd, gamefeel, polish, presentation, release, living, online, environment, materials] = await Promise.all([
    readProductionSource(),
    readLayer('./v06-hd.js?v=14a', 'v0.6 HD layer'),
    readLayer('./v07-gamefeel.js?v=14a', 'v0.7.1 game-feel layer'),
    readLayer('./v08-battle-polish.js?v=14a', 'v0.8 battle-polish layer'),
    readLayer('./v09-battle-presentation.js?v=14a', 'v0.9 battle-presentation layer'),
    readLayer('./v10-release.js?v=14a', 'v1.0 release layer'),
    readLayer('./v11-living-battlefields.js?v=14a', 'v1.1 living-battlefields layer'),
    readLayer('./v12-online.js?v=14a', 'v1.2 online-room layer'),
    readLayer('./v13-environment-depth.js?v=14a', 'v1.3 environment-depth layer'),
    readLayer('./v14-atmosphere-materials.js?v=14a', 'v1.4 atmosphere-material layer')
  ]);

  const source = composeSource(v05, hd, gamefeel, polish, presentation, release, living, online, environment, materials);
