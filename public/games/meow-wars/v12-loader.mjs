 ...
 * Proven v0.5 gameplay + cumulative environment/combat/release/online layers.
 */
const VERSION = '1.2.0';
const BUILD = 'mw-v12-online-20260918a';
...
async function start() {
  const [v05, hd, gamefeel, polish, presentation, release, living, online] = await Promise.all([
    ...
    readLayer('./v12-online.js?v=12a', 'v1.2 online layer')
  ]);
