...
(()=>{
  ...
  function sync(){
    ...
    </article><article class="fun-card" id="mango-mayhem-account-card"><p class="eyebrow">Duck &amp; Bear Games</p><div class="big-icon" aria-hidden="true">🥭</div><h2>Mango Mayhem</h2><p>A colourful manga platform adventure around six places. Collect mangos, meet your helpers and unlock costumes. Five hearts, no timer, single player.</p><a class="primary" href="/games/mango-mayhem/">Play Mango Mayhem →</a><p class="muted tiny">Keyboard, landscape touch and gamepad. Opens the menu first. Player profiles save progress without changing website points.</p></article><article class="fun-card" id="last-luas-account-card"><p class="eyebrow">Duck &amp; Bear Games</p><div class="big-icon" aria-hidden="true">🏃 🚋</div><h2>Last Luas</h2><p>Ninety seconds to sprint down a wet cartoon Dawson Street before the final Luas leaves. Dodge tourists, cyclists, umbrellas, bins and roadworks.</p><a class="primary" href="/games/last-luas/">Play Last Luas →</a><p class="muted tiny">Single player. Keyboard or touch. Built in PlayCanvas. Build 0.5 adds the articulated Luas, upgraded Dawson Street façades, granite kerbs, parked taxis and bicycles while keeping the full doors-closing / pull-away finish.</p></article><aside class="fun-card"><h2>Before the lights go out</h2>
