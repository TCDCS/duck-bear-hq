...
(()=>{
  ...
  function sync(){
    ...
    panel.innerHTML=`<div class="cards-2"><article class="fun-card" id="wacky-races-card">
      ...
      <a class="primary" href="/games/wacky-races/?play=1">Play Wacky Races →</a>
      <p class="muted tiny">Opens its own full-page game. Keyboard, gamepad, touch or optional tilt steering. Landscape works best on phones.</p>
