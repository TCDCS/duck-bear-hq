...
const outputDir = new URL('../artifacts/meow-wars-v13-online/', import.meta.url);
...
async function waitGame(page) {
  ...
  await page.waitForFunction(() =>
    globalThis.__MEOW_WARS_BUILD === 'mw-v13-environment-depth-20260918a',
    null,
    { timeout: 30000 }
  );
...
try {
  ...
  if (finalState.some((state) => state.build !== 'mw-v13-environment-depth-20260918a')) {
