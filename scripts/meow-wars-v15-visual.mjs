...
const outputDir = new URL('../artifacts/meow-wars-v15/', import.meta.url);
...
try {
  ...
  if (variant === 'after') {
    ...
    if (transition.build !== 'mw-v15-scene-depth-20260918a') {
      throw new Error('Unexpected v1.5 build: ' + transition.build);
    }
  }
