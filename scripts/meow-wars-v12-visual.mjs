...
const outputDir = new URL('../artifacts/meow-wars-v12/', import.meta.url);
...
try {
  ...
  if (variant === 'after') {
    ...
    if (transition.build !== 'mw-v12-online-rooms-20260918a') {
      throw new Error('Unexpected v1.2 build: ' + transition.build);
    }
  }
