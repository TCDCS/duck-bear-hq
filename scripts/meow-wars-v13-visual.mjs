...
const outputDir = new URL('../artifacts/meow-wars-v13/', import.meta.url);
...
try {
  ...
  if (variant === 'after') {
    ...
    if (transition.build !== 'mw-v13-environment-depth-20260918a') {
      throw new Error('Unexpected v1.3 build: ' + transition.build);
    }
  }
